...
如果依然不可使用，请下载统信UOS系统，利用统信UOS系统的Web版本微信登陆一次。

若登陆成功即可使用本项目。若登陆不成功，请根据相关提示进行修正，直至登陆成功。

统信UOS系统的安装教程请查看[统信UOS系统安装教程](https://www.7uos.com/uos-ti-yan.html)

方法二：

首先登陆： https://filehelper.weixin.qq.com/ 

然后在登陆 wx.qq.com 即可，祝君好运！
